...
Encodes the image
Uses a pretrained 3D generative backbone
Predicts missing geometry
Generates a full 3D mesh
...
📁 Project Structure
sq2cube_AI/ ├── models/ ├── notebooks/ ├── results/ ├── src/ │ └── preprocessing/ │ ├── background_removal.py │ ├── contrast.py │ ├── denoise.py │ ├── image_utils.py │ └── resize.py ├── requirements.txt └── README.md
